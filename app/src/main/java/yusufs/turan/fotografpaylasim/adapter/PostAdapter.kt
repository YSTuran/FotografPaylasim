package yusufs.turan.fotografpaylasim.adapter

import android.view.LayoutInflater
import android.view.ViewGroup
import androidx.recyclerview.widget.RecyclerView
import com.squareup.picasso.Picasso
import yusufs.turan.fotografpaylasim.databinding.RecyclerRowBinding
...
class PostAdapter(private val postList : ArrayList<Post>) : RecyclerView.Adapter<PostAdapter.PostHolder>() {
    ...
    override fun onBindViewHolder(holder: PostHolder, position: Int) {
        ...
        holder.binding.recyclerCommentText.text = postList[position].commnent
